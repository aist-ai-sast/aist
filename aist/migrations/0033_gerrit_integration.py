# Generated for: docs/plans/2026-07-10-gerrit-integration.md (Task 3)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("aist", "0032_claude_code_integration_type"),
    ]
