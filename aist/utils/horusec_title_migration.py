...
from aist.parser_overrides import HORUSEC_SCAN_TYPE, normalize_horusec_title
...
def _queryset():
    return Finding.objects.filter(test__test_type__name__icontains=HORUSEC_SCAN_TYPE).only("id", "title")
