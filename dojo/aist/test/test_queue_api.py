...
from dojo.aist.models import AISTProjectLaunchConfig, PipelineLaunchQueue
...
class QueueAPITests(AISTApiBase):
    def test_delete_queue_item(self):
        ...
        url = reverse("dojo_aist_api:pipeline_launch_queue_detail", kwargs={"queue_id": item.id})
