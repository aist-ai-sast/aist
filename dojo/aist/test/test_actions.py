...
from dojo.aist.actions import EmailAction, SlackAction, WriteLogAction
...
class ActionsTests(TestCase):
    ...
    @patch("dojo.aist.actions.AISTSlackNotificationManager.send_message_with_file")
    ...
    @patch("dojo.aist.actions.AISTSlackNotificationManager.post_message_with_token")
    ...
    @patch("dojo.aist.actions.EmailNotificationManger.send_mail_notification")
    ...
    @patch("dojo.aist.actions.install_pipeline_logging")
